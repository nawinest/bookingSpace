<%-- 
    Document   : comment_error.jsp
    Created on : Apr 29, 2018, 9:08:46 PM
    Author     : mac
--%>
...
<html>
    ...
    <body>
        ...
        <div class="success_del">
            <h1>กรุณาเข้าสู่ระบบ <br> <span style="display:box;font-size: 0.75em;color: #e237a0;font-family: 'Kanit', sans-serif;">ระบบกำลังพาท่านไปยังหน้าเเรกของเว็บไซต์</span></h1>
