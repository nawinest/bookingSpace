...
<html>
    ...
    <body>
        ...
        <div class="success_del">
            <h1>แสดงความคิดเห็นเรียบร้อย <br> 
                <span style="display:box;font-size: 0.75em;color: #e237a0;">ระบบกำลังพาท่านไปยังหน้าสถานที่  To Page : <%= place_name %></span></h1>
        </div>
    ...
    <script>setTimeout(function () {
            window.location.href = 'place_query.do?place_name=<%= place_name %>'
        }, 2000);</script>