...
<html>
    ...
    <body>
        ...
        <div class="success_del">
            <h1>อัพเดตสถานะเรียบร้อย<br> 
                <span style="display:box;font-size: 0.75em;color: #e237a0;">ระบบกำลังพาท่านไปยังหน้าจัดการผู้ให้บริการ</span></h1>
        </div>
    ...
    <script>setTimeout(function () {
            window.location.href = 'admin_manage.jsp'
        }, 2000);</script>